...
class FixedTrimRectManager(object):
    """切り取る範囲の矩形を管理する"""
    ...
    def getRectsForDatalist(self):
        """ FixedTrimFileクラスで保存しやすいジェネレーターで返す """
        for rect in self.rects:
            yield rect.p1[0]
            yield rect.p1[1]
            yield rect.p2[0]
    ...
    def newRect(self, pos):
        ...
        self.currentRect = FixedTrimRect(self.minX, self.minY, self.maxX, self.maxY)
