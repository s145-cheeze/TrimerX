...
class FreeTrimFile(object):
    ...
    def getRectManager(self):
        """ このインスタンスが持っているFreeTrimRectManagerインスタンスを取得 """
        return self.rect_manager
    def getImageManager(self):
        """ このインスタンスが持っているFreeTrimImageManagerインスタンスを取得 """
        return self.img_manager
    def getManagers(self):
        """ このインスタンスが持っているFreeTrimRectManager, FreeTrimImageManagerインスタンスの両方を取得 """
